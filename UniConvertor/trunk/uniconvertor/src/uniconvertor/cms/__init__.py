...
# pycms - small package which provides binding
...
def cmsDoTransform2(hTransform, channel1, channel2, channel3, channel4=0):
	...
	"""
	return _pycms.transformPixel2(hTransform, channel1, channel2, channel3, channel4)
...
def cmsGetProfileName(profile):
	...
	"""
	return _pycms.getProfileName(profile)
...
def cmsGetProfileInfo(profile):
	...
	"""
	return _pycms.getProfileInfo(profile)
...
def getPixelsFromImage(image):
	...
	if image.mode == TYPE_RGB_8:
		bytes_per_pixel = 4
	return _pycms.getPixelsFromImage(image.im, width, height, bytes_per_pixel)
...
def cmsDoPixelsTransform(hTransform, pixels, width):
	...
	"""
	return _pycms.transformPixels(hTransform, pixels, width)
