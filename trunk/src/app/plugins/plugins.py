...
from app import _, dgettext, gettext, bindtextdomain, message_dir, Subscribe, config, const


# All plugins are loaded as modules in the _plugin_package_name package
# to keep the namespaces clean
_plugin_package_name = "app.Plugins"
...
def _search_dir(dir, recurse, package = 'app.Plugins'):
	try:
