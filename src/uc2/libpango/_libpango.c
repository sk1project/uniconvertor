...
pango_GetVersion(PyObject *self, PyObject *args) {
	return Py_BuildValue("s", pango_version_string());
}
...
pango_CreateContext(PyObject *self, PyObject *args) {
	...
	return Py_BuildValue("O", PyCapsule_New((void *) pcctx, NULL, (void *) g_object_unref));
}
...
pango_CreateLayout(PyObject *self, PyObject *args) {
	...
	return Py_BuildValue("O", PyCapsule_New((void *) layout, NULL, (void *) g_object_unref));
}
...
pango_CreateFontDescription(PyObject *self, PyObject *args) {
	...
	return Py_BuildValue("O", PyCapsule_New((void *) fd, NULL, (void *) pango_font_description_free));
}
...
pango_SetLayoutWidth(PyObject *self, PyObject *args) {
	...
	layout = PyCapsule_GetPointer(LayoutObj, NULL);
...
pango_SetLayoutFontDescription(PyObject *self, PyObject *args) {
	...
	layout = PyCapsule_GetPointer(LayoutObj, NULL);
	fd = PyCapsule_GetPointer(FDObj, NULL);
...
static int pango_traverse(PyObject *m, visitproc visit, void *arg) {
    Py_VISIT(GETSTATE(m)->error);
    return 0;
}

static int pango_clear(PyObject *m) {
