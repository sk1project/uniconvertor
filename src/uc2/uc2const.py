...
PAGE_FORMATS = {
    ...
    'Icon 24x24': (24 * px_to_pt, 24 * px_to_pt),
    'Icon 32x32': (32 * px_to_pt, 32 * px_to_pt),
    'Icon 48x48': (48 * px_to_pt, 48 * px_to_pt),
    'Icon 64x64': (64 * px_to_pt, 64 * px_to_pt),
    'Icon 128x128': (128 * px_to_pt, 128 * px_to_pt),
    'Slide': (1024 * px_to_pt, 768 * px_to_pt),
...
PAGE_FORMATS_MORE = {
    'Icon 16x16': ('px', 1.0 * px_to_pt),
    'Icon 22x22': ('px', 1.0 * px_to_pt),
    'Icon 24x24': ('px', 1.0 * px_to_pt),
    'Icon 32x32': ('px', 1.0 * px_to_pt),
    'Icon 48x48': ('px', 1.0 * px_to_pt),
    'Icon 64x64': ('px', 1.0 * px_to_pt),
    'Icon 128x128': ('px', 1.0 * px_to_pt),
    'Slide': ('px', 10.0 * px_to_pt),
    'A0': ('mm', 1.0 * mm_to_pt),
    'A1': ('mm', 1.0 * mm_to_pt),
    'A2': ('mm', 1.0 * mm_to_pt),
    'A3': ('mm', 1.0 * mm_to_pt),
    ...
    'C5': ('mm', 1.0 * mm_to_pt),
    'C6': ('mm', 1.0 * mm_to_pt),
    'Letter': ('in', .1 * in_to_pt),
    'Legal': ('in', .1 * in_to_pt),
    'Ledger': ('in', .1 * in_to_pt),
    'Executive': ('in', .1 * in_to_pt),
    'JIS B0': ('mm', 1.0 * mm_to_pt),
    'JIS B1': ('mm', 1.0 * mm_to_pt),
    'JIS B2': ('mm', 1.0 * mm_to_pt),
    'JIS B3': ('mm', 1.0 * mm_to_pt),
    'JIS B4': ('mm', 1.0 * mm_to_pt),
    'JIS B5': ('mm', 1.0 * mm_to_pt),
    'JIS B6': ('mm', 1.0 * mm_to_pt),
    'Envelope C4': ('in', .1 * in_to_pt),
    'Envelope C5': ('in', .1 * in_to_pt),
    'Envelope C6': ('in', .1 * in_to_pt),
    'Envelope E65/DL': ('in', .1 * in_to_pt),
    'Business card #1': ('mm', 1.0 * mm_to_pt),
    'Business card #2': ('mm', 1.0 * mm_to_pt),
}
